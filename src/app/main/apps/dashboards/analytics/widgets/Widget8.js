            ...
            <AppBar position="static">
                ...
                <div className="p-16 pr-4 flex flex-row items-center justify-between">
                    ...
                    <div className="pr-16">
                        ...
                        <Typography className="h5" color="inherit">Lifetime sum of coupon sales</Typography>
                    </div>
                ...
                <div className="p-16 pt-8 flex flex-row justify-between items-end">
                    <Typography className="text-48 font-300 leading-none" color="inherit">{"$6,780"}</Typography>
                ...
                <Tabs
                    ...
                    variant="fullWidth"
                >                    
                    <Tab label="1 Week" className="min-w-0"/>
                    <Tab label="1 Month" className="min-w-0"/>
                    <Tab label="6 Months" className="min-w-0"/>
                </Tabs>
            </AppBar>
            <Line
                data={{
