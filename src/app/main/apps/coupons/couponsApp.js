...
function CouponApp()
{
    ...
    const selectedItem = useSelector(({CouponApp}) => files[CouponApp.selectedItemId]);
...
<FusePageSimple
classes={{root : "bg-red",header : "h-96 min-h-96 sm:h-160 sm:min-h-160",sidebarHeader: "h-96 min-h-96 sm:h-160 sm:min-h-160",rightSidebar : "w-320"}}
            header={
...
content={<CouponList pageLayout={pageLayout} checkedA={ state.checkedA }/>}
